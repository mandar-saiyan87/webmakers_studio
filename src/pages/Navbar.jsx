  ...
  return (
    <>
      ...
      <div className={showNav ? `fixed w-full h-screen top-0 left-0 bg-black/30 z-30 lg:hidden` : ''} onClick={() => setShownav(false)}>
        <div className={showNav ? `fixed top-0 left-0 bg-white w-[70%] h-screen ease-in duration-500 sm:w-[40%]` : 'fixed top-0 -left-[100%] duration-500'} onClick={(e) => e.stopPropagation()}>
